        ...
        >
          <div className="lg:w-3/6">
            ...
            <p className="mt-6 max-w-2xl text-xl font-semibold text-[#404040]">
              We understand the importance of maintaining good oral hygiene for
              the whole family. Our friendly and experienced team is here to
              provide personalized care and treatment to help you and your loved
              ones achieve and maintain bright and healthy smiles.
            </p>
          </div>
        ...
        <div id="services" className="mt-0 bg-white lg:mt-40">
          ...
          <div className="text-black">
            ...
            >
              <div
                id="reviews"
                className="mr-0 mb-6 w-full py-4 text-center lg:w-2/3"
              >
